...
export function ConfirmDialog({
  ...
  const confirmText = confirmLabel ?? tr('deploy.confirm');
  const cancelText  = cancelLabel  ?? tr('common.cancel');
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <Button size="sm" variant="ghost" icon={<X size={14} />} onClick={onCancel} aria-label={tr('common.close')} style={{ marginLeft: 'auto' }} />
        </div>
