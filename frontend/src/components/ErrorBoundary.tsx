    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', padding: 24 }}>
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--text)', marginBottom: 8 }}>{i18n.t('common.unexpectedError')}</div>
          <p style={{ fontSize: 13, color: 'var(--text-dim)', margin: '0 0 18px', lineHeight: 1.5 }}>{i18n.t('app.pageRenderError')}</p>
          {this.state.message && (
            <pre style={{
          ...
          }}>{i18n.t('common.reloadPage')}</button>
        </div>
      </div>
    );
  }
