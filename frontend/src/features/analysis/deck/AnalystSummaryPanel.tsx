  ...
  return (
    <>
      <Card style={{ padding: '12px 14px' }}>
        ...
        <div style={{ fontSize: 10.5, color: 'var(--text-dim)', marginTop: 8 }}>{tr('analysis.derivedNotDecision')}</div>
      </Card>
      ...
      <Card style={{ padding: '12px 14px' }}>
        ...
        <div style={{ fontSize: 10.5, color: 'var(--text-dim)', marginTop: 8 }}>{tr('analysis.severityCredibilityRelevance')}</div>
      </Card>
    </>
  );
}
