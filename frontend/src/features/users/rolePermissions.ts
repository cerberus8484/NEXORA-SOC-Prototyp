...
export const PERMISSION_LABELS: Record<keyof PermissionRow, string> = {
  ...
  createTicket:         i18n.t('manual.createEditTicket'),
  runHunts:             i18n.t('manual.startHunts'),
  generateAiAnalysis:   i18n.t('manual.generateAiAnalysis'),
  applyFpException:     i18n.t('manual.applyFpException'),
  manageSettings:       i18n.t('ui.manageSettingsUsers'),
  approveAiSuggestions: i18n.t('ui.approveAiSuggestions'),
};
