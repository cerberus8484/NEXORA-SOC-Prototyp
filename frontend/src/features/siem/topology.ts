...
export const ZONES: ZoneDef[] = [
  {
    ...
    subnet: '10.10.10.0/24 · GW 10.10.10.1 · vmbr10',
    agents: [
      'WEC01', 'wazuh-server', 'OPNsense.localdomain', 'Nexora', 'ollama',
      'DC01', 'grafana', 'opensourcebackup', 'ids-sensor',
    ],
    hosts: [
      { label: 'Wazuh Manager', ip: '10.10.10.77', agent: 'wazuh-server' },
      { label: 'Nexora SOC',    ip: '10.10.10.75', agent: 'Nexora' },
      { label: 'Ollama LLM',    ip: '10.10.10.78', agent: 'ollama' },
      { label: 'BackupServer',  ip: '10.10.10.72', agent: 'opensourcebackup' },
      { label: 'Grafana',       ip: '10.10.10.55', agent: 'grafana' },
      { label: 'IDS-Sensor · Suricata', ip: '10.10.10.60', agent: 'ids-sensor' },
      { label: 'DC01 · AD example.local', ip: '10.10.10.10', agent: 'DC01', note: 'direkt + WEF' },
      { label: 'WEC01 · Event Collector', ip: '10.10.10.11', agent: 'WEC01' },
      { label: 'OPNsense GW',   ip: '10.10.10.1',  agent: 'OPNsense.localdomain' },
    ],
  },
  {
  ...
  },
  {
    ...
    agents: [],
    hosts: [
      { label: 'Kali', ip: '10.0.30.10', note: 'kein Agent' },
    ],
  },
  {
...
export const QUICK_LINKS: QuickLink[] = [
  { label: 'OPNsense UI',     url: 'https://opnsense.example',  desc: 'Firewall · VLANs · filterlog' },
  { label: 'Proxmox VE',      url: 'https://proxmox.example:8006', desc: 'Hypervisor' },
  { label: 'Wazuh Dashboard', url: 'https://wazuh.example',     desc: 'SIEM · Alerts · Agents' },
];
