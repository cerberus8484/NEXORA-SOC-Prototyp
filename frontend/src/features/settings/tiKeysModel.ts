...
export const TI_PROVIDER_META: TiProviderMeta[] = [
  { provider: 'virustotal', label: 'VirusTotal', docsHint: 'API-Key v3 (Free-Tier ~4 Anfragen/min). Nur IP-Indikatoren.' },
  { provider: 'abuseipdb',  label: 'AbuseIPDB',  docsHint: 'API-Key v2 (/check). Nur öffentliche IPs.' },
];
