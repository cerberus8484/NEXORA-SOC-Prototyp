  ...
  useEffect(() => {
    ...
    auditApi.recent(50, { signal: ctrl.signal })
      ...
      .catch((err: unknown) => {
        ...
        setError('Sicherheitsereignisse konnten nicht geladen werden.');
      })
      ...
      <CardBody>
        ...
        {!loading && !error && events.length === 0 && (
          <EmptyState
            ...
            message="Noch keine Login- oder Benutzer-Änderungs-Ereignisse vorhanden."
          />
        )}
        {!loading && !error && events.length > 0 && (
          <div style={s.list}>
        ...
        <div style={s.pwRow}>
          <span style={{ fontSize: 12, color: 'var(--text-dim)' }}>Letzte Passwortänderung</span>
          <span
