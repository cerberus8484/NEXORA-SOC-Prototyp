...
const ACTION_MAP: Record<SecurityAction, ActionMeta> = {
  LOGIN:               { description: i18n.t('audit.loginSuccess'),              isSuccess: true  },
  LOGIN_FAILED:        { description: i18n.t('auth.failed'),            isSuccess: false },
  USER_ACTIVE_CHANGE:  { description: i18n.t('settings.accountStatusChangedLockedActivated'), isSuccess: true  },
  USER_PASSWORD_RESET: { description: i18n.t('settings.passwordReset'),              isSuccess: true  },
  USER_ROLE_CHANGE:    { description: i18n.t('settings.rolePermissionsChanged'),     isSuccess: true  },
};
