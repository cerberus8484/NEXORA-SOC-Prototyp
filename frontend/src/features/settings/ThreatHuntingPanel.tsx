...
const PLANNED_FEATURES: PlannedFeature[] = [
  {
    title: 'Hunt-Automatisierung',
    description:
      'Hunts automatisch auf Basis von Threat-Intel-Feeds starten — keine Scheduler-Engine vorhanden.',
  },
  {
    title: 'Zeitpläne (Scheduling)',
    description:
      'Geplante, wiederkehrende Hunt-Runs (täglich, wöchentlich) — kein Cron-Backend implementiert.',
  },
  {
    title: 'Auto-Trigger bei Alerts',
    description:
      'Hunt automatisch anstoßen wenn ein Wazuh-Alert mit bestimmten Regeln eingeht — geplant.',
  },
];
  ...
  return (
    <div style={s.plannedCard}>
      ...
      <div style={s.plannedBanner}>
        <Clock size={12} />
        <span>geplant – keine Scheduler-Engine</span>
      </div>
    </div>
  );
}
    ...
    <div style={s.root}>
      ...
      <div>
        ...
        <p style={s.pageSubtitle}>
          Übersicht der verfügbaren vorgefertigten Hunts. Starten und verwalten im Hunt-Bereich.
        </p>
      </div>
      ...
      <Card>
        <CardHeader
          title={
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span>Verfügbare Hunt-Typen</span>
        ...
        <CardBody>
          ...
          {!loading && error === null && items.length === 0 && (
            <EmptyState
              icon={<Search size={28} />}
              title="Keine Hunts im Katalog"
              message="Das Backend hat keinen Hunt-Katalog zurückgeliefert."
            />
          )}
      ...
      <Card>
        ...
        <CardBody>
          ...
          >
            ...
            <span>
              Die folgenden Funktionen sind noch nicht implementiert.
              Es gibt keine Scheduler-Engine im Backend — alle Anzeigen hier wären Fake-Daten.
            </span>
          </div>
