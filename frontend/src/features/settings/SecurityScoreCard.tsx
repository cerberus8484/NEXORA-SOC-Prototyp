    ...
    <Card>
      ...
      <CardBody>
        <div style={s.row}>
          ...
          <div style={s.legend}>
            <LegendRow label="Passwort-Stärke" value={
            ...
            <LegendRow label="MFA"  value="0 % — nicht implementiert" color="var(--danger)" />
            <LegendRow label="SSO"  value="Nicht konfiguriert"         color="var(--text-dim)" />
          </div>
        </div>
