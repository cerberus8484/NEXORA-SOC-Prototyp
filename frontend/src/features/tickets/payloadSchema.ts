...
export const PAYLOAD_SCHEMA: Record<string, PayloadFieldDef[]> = {
  ...
  File: [
    ...
    f('size', i18n.t('ui.size'), 'text', { mono: true, placeholder: '1.4 MB / 1482763 bytes' }),
  ...
  Script: [
    ...
    f('lang', i18n.t('profile.languageLabel'), 'text', { placeholder: 'PowerShell / Python / VBScript / Batch' }),
  ...
  Command: [
    ...
    f('cmd', i18n.t('ui.fullCommand'), 'textarea', { mono: true, full: true }),
  ...
  Email: [
    ...
    f('notes', 'Notizen', 'textarea', { full: true, placeholder: i18n.t('tickets.phishingPlaceholder') }),
  ],
  'Registry-Key': [
  ...
  'User-Agent': [
    ...
    f('tool', i18n.t('ui.associatedTool'), 'text', { placeholder: 'Cobalt Strike / Metasploit / curl' }),
  ...
  Hash: [
    ...
    f('notes', 'Notizen', 'textarea', { full: true, placeholder: i18n.t('tickets.detectionsPlaceholder') }),
  ],
  'Encoded String': [
    ...
    f('notes', 'Notizen', 'textarea', { full: true, placeholder: i18n.t('tickets.decodeContextPlaceholder') }),
  ],
  Andere: [
    f('label', i18n.t('common.labelName'), 'text', { placeholder: 'z.B. Cookie, Token, Certificate …' }),
    f('value', i18n.t('common.value'), 'textarea', { mono: true, full: true }),
