...
const TLS_REJECT_UNAUTHORIZED = process.env.QRADAR_TLS_REJECT_UNAUTHORIZED === 'true';
...
class QRadarDashboardProvider {
  ...
  constructor({ http = null } = {}) {
    this.key   = 'qradar';
    this._http = http || new RealHttpClient({ rejectUnauthorized: TLS_REJECT_UNAUTHORIZED, timeout: 10_000 });
