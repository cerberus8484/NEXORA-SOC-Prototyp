...
// KRITISCH: noDefaults. Ohne das injiziert Joi für JEDES absente Feld den `.default('')`
// aus createTicketSchema; die validate-Middleware ersetzt den Body damit, und der Merge
// in Ticket.update() überschreibt dann jedes nicht mitgesendete Feld mit '' → ein
// Partial-PUT (z. B. nur { decision } aus dem Deck) leert srcIp/dstIp/logs/mitre etc.
// aus (Datenverlust). Mit noDefaults bleiben absente Felder undefined → der Merge lässt
// sie unangetastet. Bewusstes Leeren bleibt möglich (Feld explizit mit '' senden).
