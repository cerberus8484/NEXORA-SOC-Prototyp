...
class InMemoryDeployRepository {
  ...
  async setConnectorCertificate(id, certificate) { const c = this._connectors.get(id); if (!c) return null; const updated = { ...c, tlsCertificatePem: certificate.pem, tlsCertificateFingerprint: certificate.fingerprint }; this._connectors.set(id, updated); return { ...updated }; }
