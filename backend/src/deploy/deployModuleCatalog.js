...
const VALID_KINDS = ['vm-clone', 'agent-install'];

for (const def of CATALOG) {
  const required = [...COMMON_REQUIRED, ...(def.kind === 'agent-install' ? AGENT_INSTALL_REQUIRED : VM_CLONE_REQUIRED)];
