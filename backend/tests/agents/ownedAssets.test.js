...
describe('ownedAssets.loadConfigFromEnv()', () => {
  ...
  test('parst kommaseparierte Honeypot-IPs (getrimmt, leere weg)', () => {
    const cfg = loadConfigFromEnv({ OWNED_HONEYPOT_IPS: ' 31.70.103.246 , , 10.0.10.80 ' });
    expect(cfg.honeypotIps).toEqual(['31.70.103.246', '10.0.10.80']);
  });
